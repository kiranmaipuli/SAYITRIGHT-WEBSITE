...
$err1 = $err2 = $err3 = $err4 = $err5 = $msg = $err = $success = "";
	...
	if(isset($_POST['send']))
	{
		...
		list($var1,$var2) = validation($array_validate);
			...
			else
			{
				...
				$statement->bindvalue(4,$_POST['placework']);
				$statement->bindvalue(5,$_POST['school']);
	...
	header("Refresh: 5; url = individual.php");
	}
...
?>
	...
	<div class="wrapper">
		...
		<form action="" method="POST" onsubmit="return individual()">  		
		<div class="formdivision">
			<hr width="80%" size="0.2" color="#EAE9E8">
				...
				<input id="elementposition" type="text" name="placework" placeholder="Enter place work" required>
				<span id="placeworkerror"><?php echo $err2; ?></span>
				<input id="elementposition" type="text" name="school" placeholder="Enter school" required>
				<span id="schoolerror"><?php echo $err3; ?></span>
