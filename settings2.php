...
<body>
	<div class="wrapper">
		<div class="start">
				...
				<li><a href="university.php">CONFERENCES</a></li>
				<li><a href="company.php">EVENTS</a></li>
				<li><a id="active" href="settings2.php">SETTINGS</a></li>
				</div>
		</div>
		...
		<div class="settingscontainer">
			...
			<div class="flexusage">
				<div>
					...
					<input class="forimage" class="button" name="changeimage" type="submit" value="CHANGE IMAGE">
				</div>
